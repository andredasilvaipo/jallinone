...
<OBJECT classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93"
    ...
    <PARAM NAME=archive VALUE="clientjaio.jar,clientos.jar,jcalendar.jar,jnlp.jar,looks-2.0.1.jar,OfficeLnFs_2.7.jar,jasperreports-1.2.7.jar,itext-1.3.1.jar,hessian-3.1.5.jar">
...
<EMBED type="application/x-java-applet;jpi-version=1.4.2" width="500"
   ...
   archive="clientjaio.jar,clientos.jar,jcalendar.jar,jnlp.jar,looks-2.0.1.jar,OfficeLnFs_2.7.jar,jasperreports-1.2.7.jar,itext-1.3.1.jar,hessian-3.1.5.jar" MAYSCRIPT="true"
   SERVERURL=
        "<%=request.getScheme()%>://<%= request.getServerName()+
        ":"+request.getServerPort()+
        request.getContextPath()  %>/controller" 
