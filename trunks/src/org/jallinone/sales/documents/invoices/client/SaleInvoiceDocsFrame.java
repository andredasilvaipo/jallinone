...
public class SaleInvoiceDocsFrame extends InternalFrame implements CurrencyColumnSettings {
  ...
  public SaleInvoiceDocsFrame(SaleInvoiceDocsController itemsController) {
    try {
      ...
      types.add(ApplicationConsts.SALE_INVOICE_DOC_TYPE);
      types.add(ApplicationConsts.SALE_INVOICE_FROM_DN_DOC_TYPE);
      types.add(ApplicationConsts.SALE_INVOICE_FROM_SD_DOC_TYPE);
