...
public class ValidatePriceItemCodeBean implements ValidatePriceItemCode {
  ...
  public VOListResponse validatePriceItemCode(LookupValidationParams pars,String serverLanguageId,String username) throws Throwable{
    ...
    try {
      ...
      String sql =
          "select SAL02_ITEM_PRICES.COMPANY_CODE_SYS01,SAL02_ITEM_PRICES.ITEM_CODE_ITM01,"+
          ...
          "SAL02_ITEM_PRICES.VALUE,SAL02_ITEM_PRICES.START_DATE,SAL02_ITEM_PRICES.END_DATE,ITM01_ITEMS.SERIAL_NUMBER_REQUIRED, "+
          ...
          " from SAL02_ITEM_PRICES,SYS10_COMPANY_TRANSLATIONS,ITM01_ITEMS,REG02_MEASURE_UNITS,SYS10_TRANSLATIONS SYS10_VAT,REG01_VATS where "+
          ...
          "SAL02_ITEM_PRICES.COMPANY_CODE_SYS01 = ? and "+
          ...
          "SAL02_ITEM_PRICES.PRICELIST_CODE_SAL01=? and "+
          "SAL02_ITEM_PRICES.START_DATE<=? and "+
      ...
      if (Boolean.TRUE.equals(pars.getLookupValidationParameters().get(ApplicationConsts.VALIDATE_BARCODE))) {
        ...
        sql += " and SAL02_ITEM_PRICES.ITEM_CODE_ITM01=? ";
      }
