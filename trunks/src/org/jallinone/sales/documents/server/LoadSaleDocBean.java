  ...
  public final Response loadSaleDoc(Connection conn,SaleDocPK pk,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      String baseSQL =
          ...
          "DOC01_SELLING.DOC_SEQUENCE,DOC01_SELLING.DOC_SEQUENCE_DOC01 "+
          " from DOC01_SELLING,SAL01_PRICELISTS,SYS10_TRANSLATIONS,REG04_SUBJECTS,SAL07_CUSTOMERS,REG03_CURRENCIES,WAR01_WAREHOUSES where "+
          ...
          "DOC01_SELLING.WAREHOUSE_CODE_WAR01=WAR01_WAREHOUSES.WAREHOUSE_CODE ";
