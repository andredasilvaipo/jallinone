 ...
 * <p>Description: Helper class used to fetch a specific sale header document from DOC01 table.</p>
 ...
 * @version 1.0
 */
public class LoadSaleDocBean {


  public LoadSaleDocBean() {
  }
   ...
   */
  public final Response loadSaleDoc(Connection conn,SaleDocPK pk,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      String baseSQL =
          ...
          "DOC01_SELLING.DOC_SEQUENCE,DOC01_SELLING.DOC_SEQUENCE_DOC01,DOC01_SELLING.SECTIONAL,HIE02_HIERARCHIES.PROGRESSIVE_HIE01 "+
          " from DOC01_SELLING,SAL01_PRICELISTS,SYS10_TRANSLATIONS,REG04_SUBJECTS,SAL07_CUSTOMERS,REG03_CURRENCIES,"+
          "WAR01_WAREHOUSES,HIE02_HIERARCHIES where "+
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"loadSaleDoc","Error while fetching an existing sale order",ex);
