  ...
  private void init() {
		...
		pricelistController.addLookupListener(new LookupListener() {
			...
			public void beforeLookupAction(ValueObject parentVO) {
				...
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.COMPANY_CODE_SYS01, SaleContractDocRowsGridPanel.this.parentVO.getCompanyCodeSys01DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.COMPANY_CODE_SYS01,SaleContractDocRowsGridPanel.this.parentVO.getCompanyCodeSys01DOC01());
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.PROGRESSIVE_REG04,SaleContractDocRowsGridPanel.this.parentVO.getProgressiveReg04DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.PROGRESSIVE_REG04,SaleContractDocRowsGridPanel.this.parentVO.getProgressiveReg04DOC01());
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.CURRENCY_CODE_REG03,SaleContractDocRowsGridPanel.this.parentVO.getCurrencyCodeReg03DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.CURRENCY_CODE_REG03,SaleContractDocRowsGridPanel.this.parentVO.getCurrencyCodeReg03DOC01());
			}
