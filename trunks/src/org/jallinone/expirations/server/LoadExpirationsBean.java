  ...
  public VOListResponse loadExpirations(GridParams gridPars,String serverLanguageId,String username,ArrayList companiesList,ArrayList customizedFields) throws Throwable {
    ...
    try {
      ...
      String sql =
					...
					" LEFT OUTER JOIN (SELECT REG11_PAYMENT_TYPES.PAYMENT_TYPE_CODE,SYS10_TRANSLATIONS.DESCRIPTION "+
				  "	FROM REG11_PAYMENT_TYPES,SYS10_TRANSLATIONS WHERE "+
					" REG11_PAYMENT_TYPES.PROGRESSIVE_SYS10=SYS10_TRANSLATIONS.PROGRESSIVE AND "+
					" SYS10_TRANSLATIONS.LANGUAGE_CODE=? "+
					" ) REAL_PAYMENT_SYS10 "+
					" ON DOC19_EXPIRATIONS.REAL_PAYMENT_TYPE_CODE_REG11=REAL_PAYMENT_SYS10.PAYMENT_TYPE_CODE "+
					...
					" SYS10_TRANSLATIONS.LANGUAGE_CODE=? "+
					" ) PAYMENT_SYS10 "+
					" ON DOC19_EXPIRATIONS.PAYMENT_TYPE_CODE_REG11=PAYMENT_SYS10.PAYMENT_TYPE_CODE "+
