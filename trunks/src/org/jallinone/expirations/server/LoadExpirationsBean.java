  ...
  public VOListResponse loadExpirations(GridParams gridPars,String serverLanguageId,String username,ArrayList companiesList,ArrayList customizedFields) throws Throwable {
    ...
    try {
      ...
      String sql =
					...
					" LEFT OUTER JOIN (SELECT REG11_PAY_TYPES.COMPANY_CODE_SYS01,REG11_PAY_TYPES.PAYMENT_TYPE_CODE,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION "+
				  "	FROM REG11_PAY_TYPES,SYS10_COMPANY_TRANSLATIONS WHERE "+
					...
					" LEFT OUTER JOIN (SELECT ACC02_ACCOUNTS.ACCOUNT_CODE,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION "+
					"	FROM ACC02_ACCOUNTS,SYS10_COMPANY_TRANSLATIONS WHERE "+
