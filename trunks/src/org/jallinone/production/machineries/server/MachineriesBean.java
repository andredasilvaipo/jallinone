  ...
  public VOListResponse loadMachineries(GridParams gridParams,String serverLanguageId,String username,ArrayList companiesList,ArrayList customizedFields) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          "from PRO03_MACHINERIES,SYS10_COMPANY_TRANSLATIONS,REG03_CURRENCIES where "+
          ...
          "PRO03_MACHINERIES.COMPANY_CODE_SYS01 in ("+companies+") and "+
					"REG03_CURRENCIES.CURRENCY_CODE=PRO03_MACHINERIES.CURRENCY_CODE_REG03";
  ...
  public VOListResponse validateMachineryCode(LookupValidationParams validationPars,String serverLanguageId,String username,ArrayList customizedFields) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          "PRO03_MACHINERIES.COMPANY_CODE_SYS01='"+validationPars.getLookupValidationParameters().get(ApplicationConsts.COMPANY_CODE_SYS01)+"' and "+
					"REG03_CURRENCIES.CURRENCY_CODE=PRO03_MACHINERIES.CURRENCY_CODE_REG03";
