...
public class LoadItemBean {
   ...
   */
  public final Response loadItem(
    Connection conn,
    ItemPK pk,
...
//      attribute2dbField.put("sizeDescriptionSYS10","E.DESCRIPTION");
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"loadItem","Error while fetching an existing item",ex);
