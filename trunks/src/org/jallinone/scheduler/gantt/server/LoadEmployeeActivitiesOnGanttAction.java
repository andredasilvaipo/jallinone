  ...
  public VOListResponse loadEmployeeActivitiesOnGantt(HashMap map,String serverLanguageId,String username) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          "SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,SCH06_SCHEDULED_ACTIVITIES.DESCRIPTION "+
          "from REG04_SUBJECTS,REG07_TASKS,SYS10_COMPANY_TRANSLATIONS,SCH01_EMPLOYEES,SCH06_SCHEDULED_ACTIVITIES,SCH07_SCHEDULED_EMPLOYEES "+
          " where "+
