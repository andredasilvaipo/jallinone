    ...
    try {
      ...
      if (rows.size()>0) {
        ...
        sql =
            ...
            "PUR01_SUPPLIERS.PAYMENT_CODE_REG10,PUR04_SUPPLIER_PRICES.VALUE,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,"+
            ...
            " FROM "+
            "PUR04_SUPPLIER_PRICES,PUR01_SUPPLIERS,REG04_SUBJECTS,PUR03_SUPPLIER_PRICELISTS,PUR02_SUPPLIER_ITEMS,SYS10_COMPANY_TRANSLATIONS "+
            "WHERE PUR04_SUPPLIER_PRICES.COMPANY_CODE_SYS01=? AND "+
