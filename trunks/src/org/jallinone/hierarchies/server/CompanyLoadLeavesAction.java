 ...
 * @version 1.0
 */
public class CompanyLoadLeavesAction implements Action {

	public CompanyLoadLeavesAction() {
	}
	...
	public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
		try {
			...
			Response answer = bean.getLeaves(companyCodeSys01,progressiveHIE02,null,((JAIOUserSessionParameters)userSessionPars).getServerLanguageId(),userSessionPars.getUsername());
