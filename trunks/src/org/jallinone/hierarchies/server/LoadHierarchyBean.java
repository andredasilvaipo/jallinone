 ...
 * <p>Description: Bean used to retrieve a hierarchy tree model from HIE01 table, based on the specified hierarchy identifier..</p>
 ...
 * @version 1.0
 */
public class LoadHierarchyBean {


  public LoadHierarchyBean() {
  }
   ...
   */
  public final Response loadHierarchy(Connection conn,String langId,BigDecimal progressiveHIE02) {
