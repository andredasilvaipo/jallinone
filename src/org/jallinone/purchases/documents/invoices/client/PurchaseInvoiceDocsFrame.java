...
public class PurchaseInvoiceDocsFrame extends InternalFrame implements CurrencyColumnSettings {
  ...
  public PurchaseInvoiceDocsFrame(PurchaseInvoiceDocsController itemsController) {
    try {
      ...
      types.add(ApplicationConsts.PURCHASE_INVOICE_DOC_TYPE);
      types.add(ApplicationConsts.PURCHASE_INVOICE_FROM_DN_DOC_TYPE);
      types.add(ApplicationConsts.PURCHASE_INVOICE_FROM_PD_DOC_TYPE);
