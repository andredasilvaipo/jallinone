  ...
  public VOListResponse reorderFromMinStocks(
    ...
    try {
      ...
      String sql =
          ...
          " from ITM23_VARIANT_MIN_STOCKS,ITM01_ITEMS,REG01_VATS,SYS10_COMPANY_TRANSLATIONS T1,SYS10_TRANSLATIONS T2 where "+
          ...
          "ITM01_ITEMS.ENABLED='Y' AND "+
					"ITM01_ITEMS.COMPANY_CODE_SYS01=T1.COMPANY_CODE_SYS01 AND "+
          ...
          "(SELECT PUR04_SUPPLIER_ITEM_PRICES.ITEM_CODE_ITM01 FROM PUR04_SUPPLIER_ITEM_PRICES,PUR03_SUPPLIER_PRICELISTS "+
          " WHERE PUR04_SUPPLIER_ITEM_PRICES.COMPANY_CODE_SYS01=? AND "+
      ...
      if (rows.size()>0) {
        ...
        sql =
            "SELECT PUR04_SUPPLIER_ITEM_PRICES.ITEM_CODE_ITM01,PUR04_SUPPLIER_ITEM_PRICES.PROGRESSIVE_REG04,"+
            "PUR01_SUPPLIERS.SUPPLIER_CODE,REG04_SUBJECTS.NAME_1,PUR04_SUPPLIER_ITEM_PRICES.PRICELIST_CODE_PUR03,"+
            "PUR01_SUPPLIERS.PAYMENT_CODE_REG10,PUR04_SUPPLIER_ITEM_PRICES.VALUE,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,"+
            "PUR02_SUPPLIER_ITEMS.SUPPLIER_ITEM_CODE,PUR04_SUPPLIER_ITEM_PRICES.START_DATE,PUR04_SUPPLIER_ITEM_PRICES.END_DATE, "+
            "PUR02_SUPPLIER_ITEMS.UM_CODE_REG02,PUR02_SUPPLIER_ITEMS.MIN_PURCHASE_QTY,PUR02_SUPPLIER_ITEMS.MULTIPLE_QTY "+
            " FROM "+
            "PUR04_SUPPLIER_ITEM_PRICES,PUR01_SUPPLIERS,REG04_SUBJECTS,PUR03_SUPPLIER_PRICELISTS,PUR02_SUPPLIER_ITEMS,SYS10_COMPANY_TRANSLATIONS "+
            "WHERE PUR04_SUPPLIER_ITEM_PRICES.COMPANY_CODE_SYS01=? AND "+
            ...
            "PUR03_SUPPLIER_PRICELISTS.CURRENCY_CODE_REG03=? AND "+
            "PUR04_SUPPLIER_ITEM_PRICES.START_DATE<=? AND "+
						"(PUR04_SUPPLIER_ITEM_PRICES.END_DATE>=? or PUR04_SUPPLIER_ITEM_PRICES.END_DATE is null) AND "+
            ...
            "PUR04_SUPPLIER_ITEM_PRICES.ITEM_CODE_ITM01 IN "+
            ...
            "ORDER BY PUR04_SUPPLIER_ITEM_PRICES.VALUE,PUR04_SUPPLIER_ITEM_PRICES.PRICELIST_CODE_PUR03";
