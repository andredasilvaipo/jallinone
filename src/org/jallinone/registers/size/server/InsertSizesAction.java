 ...
 * <p>Description: Action class used to insert new sizes in REG14 table.</p>
 ...
 * @version 1.0
 */
public class InsertSizesAction implements Action {


  public InsertSizesAction() {
  }
  ...
  public final Response executeCommand(Object inputPar,
    ...
    try {
      ...
      attribute2dbField.put("sizeCodeREG14","SIZE_CODE");
      attribute2dbField.put("progressiveSys10REG14","PROGRESSIVE_SYS10");
      attribute2dbField.put("enabledREG14","ENABLED");

      Response res = null;
      for(int i=0;i<list.size();i++) {
        vo = (SizeVO)list.get(i);
        vo.setEnabledREG14("Y");

        // insert record in SYS10...
        progressiveSYS10 = TranslationUtils.insertTranslations(vo.getDescriptionSYS10(),conn);
        vo.setProgressiveSys10REG14(progressiveSYS10);
      ...
      Logger.error(userSessionPars.getUsername(), this.getClass().getName(),
                   "executeCommand", "Error while inserting new sizes", ex);
      try {
        conn.rollback();
      }
      catch (Exception ex3) {
