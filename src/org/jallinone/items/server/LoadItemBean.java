  ...
  public BigDecimal getProgressiveHie02ITM01(ItemPK pk,String username) throws Throwable {
	  ...
	  try {
		  ...
		  pstmt = conn.prepareStatement(
				  "SELECT HIE02_COMPANY_HIERARCHIES.PROGRESSIVE_HIE01 FROM "+
				  "HIE02_COMPANY_HIERARCHIES,ITM01_ITEMS WHERE " +
				  "ITM01_ITEMS.COMPANY_CODE_SYS01=? AND ITM01_ITEMS.ITEM_CODE=? AND " +
					"ITM01_ITEMS.COMPANY_CODE_SYS01=HIE02_COMPANY_HIERARCHIES.COMPANY_CODE_SYS01 AND "+
				  "ITM01_ITEMS.PROGRESSIVE_HIE02=HIE02_COMPANY_HIERARCHIES.PROGRESSIVE "
		  );
...
//      attribute2dbField.put("sizeDescriptionSYS10","E.DESCRIPTION");
      ...
      attribute2dbField.put("barcodeTypeITM01","ITM01_ITEMS.BARCODE_TYPE");
			...
			attribute2dbField.put("brandCodeITM01","ITM01_ITEMS.BRAND_CODE_ITM31");
      ...
      String baseSQL =
          ...
          "ITM01_ITEMS.NO_WAREHOUSE_MOV,ITM01_ITEMS.SHEET_CODE_ITM25,ITM01_ITEMS.BRAND_CODE_ITM31,ITM31_BRANDS.DESCRIPTION "+
          " from "+
          "SYS10_COMPANY_TRANSLATIONS A,SYS10_TRANSLATIONS B,REG01_VATS,REG02_MEASURE_UNITS REG02_A,SYS10_COMPANY_TRANSLATIONS C,HIE01_COMPANY_LEVELS,ITM01_ITEMS "+
					"LEFT OUTER JOIN ITM31_BRANDS ON "+
					"ITM01_ITEMS.COMPANY_CODE_SYS01=ITM31_BRANDS.COMPANY_CODE_SYS01 AND "+
					"ITM01_ITEMS.BRAND_CODE_ITM31=ITM31_BRANDS.BRAND_CODE "+
          "LEFT OUTER JOIN "+
          "(select SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,PRO01_MANUFACTURES.MANUFACTURE_CODE,PRO01_MANUFACTURES.COMPANY_CODE_SYS01 "+
          "from PRO01_MANUFACTURES,SYS10_COMPANY_TRANSLATIONS where "+
					"PRO01_MANUFACTURES.COMPANY_CODE_SYS01=SYS10_COMPANY_TRANSLATIONS.COMPANY_CODE_SYS01 and "+
          "PRO01_MANUFACTURES.PROGRESSIVE_SYS10=SYS10_COMPANY_TRANSLATIONS.PROGRESSIVE and "+
          "SYS10_COMPANY_TRANSLATIONS.LANGUAGE_CODE=?) PRO01 ON "+
          ...
          "REG01_VATS.PROGRESSIVE_SYS10=B.PROGRESSIVE and "+
				   "B.LANGUAGE_CODE=? and "+
					"HIE01_COMPANY_LEVELS.COMPANY_CODE_SYS01=ITM01_ITEMS.COMPANY_CODE_SYS01 and "+
          "HIE01_COMPANY_LEVELS.PROGRESSIVE=ITM01_ITEMS.PROGRESSIVE_HIE01 and "+
					"HIE01_COMPANY_LEVELS.COMPANY_CODE_SYS01=C.COMPANY_CODE_SYS01 and "+
          "HIE01_COMPANY_LEVELS.PROGRESSIVE=C.PROGRESSIVE and C.LANGUAGE_CODE=? and "+
      ...
      if (!res.isError()) {
        ...
        if (vo.getAddProgressiveSys10ITM01()!=null) {
          ...
          rset = stmt.executeQuery(
              "select DESCRIPTION from SYS10_COMPANY_TRANSLATIONS where "+
					    "COMPANY_CODE_SYS01='"+vo.getCompanyCodeSys01()+"' and "+
