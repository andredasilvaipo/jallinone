...
public class UpdateSubjectAction implements Action {
  ...
  public final Response executeCommand(Object inputPar,
    ...
    try {
      ...
      if (oldVO instanceof PeopleVO) {
        peopleBean.update(conn,(PeopleVO)oldVO,(PeopleVO)newVO,userSessionPars,context);
      }
      else {
        orgBean.update(conn,(OrganizationVO)oldVO,(OrganizationVO)newVO,userSessionPars,context);
      }

      Response answer = new VOResponse(inputPar);
