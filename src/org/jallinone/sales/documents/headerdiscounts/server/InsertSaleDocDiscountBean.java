 ...
 * <p>Description: Helper class used to insert a new customer discount for a sale document in the DOC05 table.</p>
 ...
 * @version 1.0
 */
public class InsertSaleDocDiscountBean {


  public InsertSaleDocDiscountBean() {
  }
   ...
   */
  public final Response insertSaleDocDiscount(Connection conn,SaleDocDiscountVO vo,
    ...
    try {
      ...
      EventsManager.getInstance().processEvent(new GenericEvent(
        this,
        "InsertSaleDocDiscountBean.insertSaleDocDiscoun.",
