...
public class InsertSaleDocActivitiesAction implements Action {
  ...
  private InsertSaleDocActivityBean bean = new InsertSaleDocActivityBean();
  ...
  public final Response executeCommand(Object inputPar,
    ...
    try {
      ...
      for(int i=0;i<list.size();i++) {
        ...
        res = bean.insertSaleActivity(conn,vo,userSessionPars,request,response,userSession,context);
        if (res.isError()) {
          conn.rollback();
          return res;
        }
