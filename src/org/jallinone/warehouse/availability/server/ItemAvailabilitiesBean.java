  ...
  public VOListResponse loadBookedItems(
    ...
    try {
      ...
      String sql =
          ...
          "SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,WAR03_ITEMS_AVAILABILITY.WAREHOUSE_CODE_WAR01,WAR01_WAREHOUSES.DESCRIPTION, "+
          ...
          " from WAR03_ITEMS_AVAILABILITY,ITM01_ITEMS,SYS10_COMPANY_TRANSLATIONS,WAR01_WAREHOUSES "+
          " where "+
          ...
          "SYS10_COMPANY_TRANSLATIONS.LANGUAGE_CODE=? and WAR03_ITEMS_AVAILABILITY.COMPANY_CODE_SYS01 in ("+companies+") ";
      ...
      sql += " group by WAR03_ITEMS_AVAILABILITY.COMPANY_CODE_SYS01,WAR03_ITEMS_AVAILABILITY.ITEM_CODE_ITM01,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,"+
  ...
  public VOListResponse loadItemAvailabilities(
    ...
    try {
      ...
      String sql =
          ...
          "WAR03_ITEMS_AVAILABILITY.VARIANT_TYPE_ITM10,WAR03_ITEMS_AVAILABILITY.VARIANT_CODE_ITM15 "+
          "from "+
          "WAR03_ITEMS_AVAILABILITY,SYS10_COMPANY_TRANSLATIONS SYS10_ITM01,SYS10_COMPANY_TRANSLATIONS SYS10_LOC,ITM01_ITEMS where "+
          "WAR03_ITEMS_AVAILABILITY.COMPANY_CODE_SYS01=ITM01_ITEMS.COMPANY_CODE_SYS01 and "+
          "WAR03_ITEMS_AVAILABILITY.ITEM_CODE_ITM01=ITM01_ITEMS.ITEM_CODE and "+
					"ITM01_ITEMS.COMPANY_CODE_SYS01=SYS10_ITM01.COMPANY_CODE_SYS01 and "+
      ...
      if (gridPars.getOtherGridParams().get(ApplicationConsts.PROGRESSIVE_HIE01)!=null &&
        ...
        BigDecimal progressiveHIE02 = (BigDecimal)gridPars.getOtherGridParams().get(ApplicationConsts.PROGRESSIVE_HIE02);
				...
				pstmt.setString(1,(String)gridPars.getOtherGridParams().get(ApplicationConsts.COMPANY_CODE_SYS01));
  ...
  public VOListResponse loadOrderedItems(
    ...
    try {
      ...
      String sql =
          ...
          "from DOC07_PURCHASE_ITEMS,DOC06_PURCHASE,ITM01_ITEMS,WAR01_WAREHOUSES,SYS10_COMPANY_TRANSLATIONS SYS10_ITM01 "+
          "where "+
