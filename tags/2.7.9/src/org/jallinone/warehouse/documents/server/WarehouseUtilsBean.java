	...
	public DeliveryNotePK getDeliveryNote() {
	  ...
	  public VOResponse reinsertInSerialNumbers(GridInDeliveryNoteRowVO vo,String serverLanguageId,String username) throws Throwable {
	    ...
	    try {
	      ...
	      pstmt = conn.prepareStatement(
	        "insert into DOC11_IN_SERIAL_NUMBERS(PROGRESSIVE_DOC09,SERIAL_NUMBER,CREATE_USER,CREATE_DATE) values(?,?,?,?)"
	      );
	  ...
	  public VOListResponse loadOutDeliveryNoteRows(
	    ...
	    try {
	      ...
	      String sql =
	          ...
	          "DOC10_OUT_DELIVERY_NOTE_ITEMS.ITEM_CODE_ITM01,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,DOC10_OUT_DELIVERY_NOTE_ITEMS.QTY,"+
	          ...
	          " from DOC08_DELIVERY_NOTES,DOC10_OUT_DELIVERY_NOTE_ITEMS,ITM01_ITEMS,SYS10_COMPANY_TRANSLATIONS,REG02_MEASURE_UNITS REG02_ALIAS1,SYS10_COMPANY_TRANSLATIONS SYS10_LOC where "+
	          ...
	          "ITM01_ITEMS.PROGRESSIVE_SYS10=SYS10_COMPANY_TRANSLATIONS.PROGRESSIVE and "+
	          "SYS10_COMPANY_TRANSLATIONS.LANGUAGE_CODE=? and "+
						"DOC10_OUT_DELIVERY_NOTE_ITEMS.COMPANY_CODE_SYS01=SYS10_LOC.COMPANY_CODE_SYS01 and "+
	  ...
	  public VOResponse reinsertOutSerialNumbers(GridOutDeliveryNoteRowVO vo,String serverLanguageId,String username) throws Throwable{
	    ...
	    try {
	      ...
	      pstmt = conn.prepareStatement(
	        "insert into DOC12_OUT_SERIAL_NUMBERS(PROGRESSIVE_DOC10,SERIAL_NUMBER,CREATE_USER,CREATE_DATE) values(?,?,?,?)"
	      );
