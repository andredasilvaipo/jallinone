 ...
 * @version 1.0
 */
public class LoadItemVariantsBean {
   ...
   */
  public final Response getItemVariants(Connection conn,GridParams pars,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"getItemVariants","Error while fetching item variants list",ex);
