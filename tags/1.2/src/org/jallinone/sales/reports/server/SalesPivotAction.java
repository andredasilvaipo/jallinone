...
import org.openswing.swing.pivottable.tablemodelreaders.server.SQLReader;
...
public class SalesPivotAction implements Action {
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      Logger.debug(userSessionPars.getUsername(),this.getClass().getName(),"executeCommand",msg.toString());
...
//      );
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"executeCommand","Error while fetching pivot table data",ex);
