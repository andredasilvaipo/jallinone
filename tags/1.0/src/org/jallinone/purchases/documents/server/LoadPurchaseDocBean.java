 ...
 * @version 1.0
 */
public class LoadPurchaseDocBean {
   ...
   */
  public final Response loadPurchaseDoc(Connection conn,PurchaseDocPK pk,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      EventsManager.getInstance().processEvent(new GenericEvent(
        this,
        "LoadPurchaseDocBean.loadPurchaseDoc",
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"loadPurchaseDoc","Error while fetching an existing purchase order",ex);
