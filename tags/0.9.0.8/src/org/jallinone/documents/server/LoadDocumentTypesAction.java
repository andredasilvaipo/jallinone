...
public class LoadDocumentTypesAction implements Action {
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      String sql =
          "select DOC16_DOC_HIERARCHY.COMPANY_CODE_SYS01,DOC16_DOC_HIERARCHY.PROGRESSIVE_HIE02,DOC16_DOC_HIERARCHY.ENABLED,SYS10_TRANSLATIONS.DESCRIPTION,HIE02_HIERARCHIES.PROGRESSIVE_HIE01 from DOC16_DOC_HIERARCHY,SYS10_TRANSLATIONS,HIE02_HIERARCHIES where "+
