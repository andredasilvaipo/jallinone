...
public class LoadSaleDocRowBean implements LoadSaleDocRow {
	...
	public VOResponse loadSaleDocRow(
		...
		try {
			...
			attribute2dbField.put("pricelistCodeSal01DOC02","DOC02_SELLING_ITEMS.PRICELIST_CODE_SAL01");
			attribute2dbField.put("pricelistDescriptionDOC02","DOC02_SELLING_ITEMS.PRICELIST_DESCRIPTION");
			...
			String baseSQL =
					...
					"SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,DOC02_SELLING_ITEMS.VAT_VALUE,DOC02_SELLING_ITEMS.VAT_DESCRIPTION,DOC02_SELLING_ITEMS.START_DATE_SAL02,DOC02_SELLING_ITEMS.END_DATE_SAL02,"+
					...
					"ITM01_ITEMS.NO_WAREHOUSE_MOV,DOC02_SELLING_ITEMS.PRICELIST_CODE_SAL01,DOC02_SELLING_ITEMS.PRICELIST_DESCRIPTION,"+
					...
					" from DOC02_SELLING_ITEMS,ITM01_ITEMS,SYS10_COMPANY_TRANSLATIONS,DOC01_SELLING where "+
			...
			if (!res.isError()) {
				...
				if (vo.getProgressiveHie01DOC02()!=null) {
					pstmt = conn.prepareStatement("select DESCRIPTION from SYS10_COMPANY_TRANSLATIONS where COMPANY_CODE_SYS01='"+vo.getCompanyCodeSys01DOC02()+"' and PROGRESSIVE=? and LANGUAGE_CODE=?");
