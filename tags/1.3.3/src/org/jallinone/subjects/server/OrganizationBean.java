...
public class OrganizationBean {
   ...
   */
  public final void checkOrganizationExist(Connection conn,OrganizationVO vo,UserSessionParameters userSessionPars,ServletContext context) throws Throwable {
    ...
    try {
      ...
      if (rset.next())
        throw new Exception(factory.getResources(serverLanguageId).getResource("there is already another organization with the same corporate name."));
    }
    finally {
      try {
        rset.close();
   ...
   */
  public final void insert(Connection conn,boolean generateProgressive,OrganizationVO vo,UserSessionParameters userSessionPars,ServletContext context) throws Throwable  {
    if (vo.getProgressiveREG04()==null)
      checkOrganizationExist(conn,vo,userSessionPars,context);
   ...
   * Update record.
   */
  public final Response update(Connection conn,OrganizationVO oldVO,OrganizationVO newVO,UserSessionParameters userSessionPars,ServletContext context) throws Throwable  {
    checkOrganizationExist(conn,newVO,userSessionPars,context);
