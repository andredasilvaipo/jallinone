  ...
  public VOResponse loadCallOutRequest(CallOutRequestPK pk,String serverLanguageId,String username,ArrayList customizedFields ) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          "SCH03_CALL_OUT_REQUESTS.DESCRIPTION,SCH03_CALL_OUT_REQUESTS.CALL_OUT_CODE_SCH10,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,"+
          ...
          "from SCH10_CALL_OUTS,SYS10_COMPANY_TRANSLATIONS,SCH03_CALL_OUT_REQUESTS "+
					"LEFT OUTER JOIN ("+
					" SELECT ITM01_ITEMS.COMPANY_CODE_SYS01,ITM01_ITEMS.ITEM_CODE,SYS10_COMPANY_TRANSLATIONS.DESCRIPTION,ITM01_ITEMS.PROGRESSIVE_HIE02 "+
					" FROM ITM01_ITEMS,SYS10_COMPANY_TRANSLATIONS WHERE "+
          ...
          "SCH03_CALL_OUT_REQUESTS.CALL_OUT_CODE_SCH10=SCH10_CALL_OUTS.CALL_OUT_CODE and "+
					"SCH10_CALL_OUTS.COMPANY_CODE_SYS01=SYS10_COMPANY_TRANSLATIONS.COMPANY_CODE_SYS01 and "+
          "SCH10_CALL_OUTS.PROGRESSIVE_SYS10=SYS10_COMPANY_TRANSLATIONS.PROGRESSIVE and "+
      ...
      attribute2dbField.put("callOutDescriptionSYS10","SYS10_COMPANY_TRANSLATIONS.DESCRIPTION");
  ...
  public VOListResponse loadCallOutRequests(GridParams pars,String serverLanguageId,String username,ArrayList companiesList) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          " from SCH03_CALL_OUT_REQUESTS,SCH10_CALL_OUTS,SYS10_COMPANY_TRANSLATIONS,REG04_SUBJECTS where "+
          "SCH03_CALL_OUT_REQUESTS.CALL_OUT_CODE_SCH10=SCH10_CALL_OUTS.CALL_OUT_CODE and "+
					"SCH10_CALL_OUTS.COMPANY_CODE_SYS01=SYS10_COMPANY_TRANSLATIONS.COMPANY_CODE_SYS01 and "+
          "SCH10_CALL_OUTS.PROGRESSIVE_SYS10=SYS10_COMPANY_TRANSLATIONS.PROGRESSIVE and "+
          "SYS10_COMPANY_TRANSLATIONS.LANGUAGE_CODE=? and "+
