 ...
 * @version 1.0
 */
public class ValidateSizeCodeAction implements Action {


  public ValidateSizeCodeAction() {
  }
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      String sql =
          ...
          "REG14_SIZES.ENABLED='Y' and "+
          "REG14_SIZES.SIZE_CODE='"+validationPars.getCode()+"'";
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"executeCommand","Error while validating size code",ex);
