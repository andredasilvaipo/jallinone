 ...
 * @version 1.0
 */
public class ValidateColorCodeAction implements Action {


  public ValidateColorCodeAction() {
  }
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      String sql =
          ...
          "REG13_COLORS.ENABLED='Y' and "+
          "REG13_COLORS.COLOR_CODE='"+validationPars.getCode()+"'";
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"executeCommand","Error while validating color code",ex);
