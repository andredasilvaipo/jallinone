...
public class LoadProductVariantsMatrixAction implements Action {
  ...
  private LoadItemVariantsAction loadItemVariantsAction = new LoadItemVariantsAction();
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
      ...
      for(int i=0;i<managedVariants.size();i++) {
        ...
        answer = loadItemVariantsAction.executeCommand(gridParams,userSessionPars,request,response,userSession,context);
        if (answer.isError())
          return answer;
