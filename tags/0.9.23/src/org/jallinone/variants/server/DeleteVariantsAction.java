...
public class DeleteVariantsAction implements Action {
  ...
  public final Response executeCommand(Object inputPar,UserSessionParameters userSessionPars,HttpServletRequest request, HttpServletResponse response,HttpSession userSession,ServletContext context) {
    ...
    try {
     ...
     java.util.List list =  (ArrayList)((Object[])inputPar)[1];
     VariantVO vo = null;
      for(int i=0;i<list.size();i++) {
        ...
        stmt.execute(
          ...
          "where COMPANY_CODE_SYS01='"+vo.getCompanyCodeSys01()+"' and VARIANT_CODE='"+vo.getVariantCode()+"' and VARIANT_TYPE='"+vo.getVariantType()+"'"
        );
      }
      ...
      Logger.error(userSessionPars.getUsername(),this.getClass().getName(),"executeCommand","Error while deleting existing variant types",ex);
      try {
        conn.rollback();
      }
      catch (Exception ex3) {
