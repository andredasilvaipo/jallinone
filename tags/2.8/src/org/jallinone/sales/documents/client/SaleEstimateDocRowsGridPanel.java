  ...
  private void init() {
		...
		pricelistController.addLookupListener(new LookupListener() {
			...
			public void beforeLookupAction(ValueObject parentVO) {
				...
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.COMPANY_CODE_SYS01, SaleEstimateDocRowsGridPanel.this.parentVO.getCompanyCodeSys01DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.COMPANY_CODE_SYS01,SaleEstimateDocRowsGridPanel.this.parentVO.getCompanyCodeSys01DOC01());
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.PROGRESSIVE_REG04,SaleEstimateDocRowsGridPanel.this.parentVO.getProgressiveReg04DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.PROGRESSIVE_REG04,SaleEstimateDocRowsGridPanel.this.parentVO.getProgressiveReg04DOC01());
				pricelistDataLocator.getLookupFrameParams().put(ApplicationConsts.CURRENCY_CODE_REG03,SaleEstimateDocRowsGridPanel.this.parentVO.getCurrencyCodeReg03DOC01());
				pricelistDataLocator.getLookupValidationParameters().put(ApplicationConsts.CURRENCY_CODE_REG03,SaleEstimateDocRowsGridPanel.this.parentVO.getCurrencyCodeReg03DOC01());
			}
...
//    controlDeliveryDate.setLowerLimit(new java.sql.Date(System.currentTimeMillis()));
    ...
    detailPanel.add(variantsPanel,    new GridBagConstraints(0, 2, 8, 1, 1.0, 1.0
