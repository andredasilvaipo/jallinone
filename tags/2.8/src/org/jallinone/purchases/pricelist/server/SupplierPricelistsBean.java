  ...
  public VOListResponse loadSupplierPricelists(GridParams gridParams,String serverLanguageId,String username,ArrayList companiesList,ArrayList customizedFields) throws Throwable {
    ...
    try {
      ...
      String sql =
          ...
          "from PUR03_SUPPLIER_PRICELISTS,SYS10_COMPANY_TRANSLATIONS,REG04_SUBJECTS,REG03_CURRENCIES "+
          "where "+
          ...
          "REG04_SUBJECTS.PROGRESSIVE=PUR03_SUPPLIER_PRICELISTS.PROGRESSIVE_REG04 AND "+
